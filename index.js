...
function displayCriteria(criteriaArr) {
    ...
    function handleSubmit(e) {
        ...
        const addedStrand = document.querySelector("#assessd-criterion");
        addedStrand.textContent = dropdown.value;

        const addedReflection1 = document.querySelector("#added-reflection1");
        addedReflection1.textContent = reflection1.value;

        const addedReflection2 = document.querySelector("#added-reflection2");
        addedReflection2.textContent = reflection2.value;

        const addedReflection3 = document.querySelector("#added-reflection3");
        addedReflection3.textContent = reflection3.value;
    };
